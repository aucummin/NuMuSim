...
int main(int argc, char **argv)
{
  ...
  //======================= Loop over events
  int i = 0;
  //Must use double for attempted events because int can overflow easily
  long double attempted_evts = 0.0;
  ...
  if((tag==1)&&(Energy_GeV>=Elim))
    ...
    if(!((float)i/(0.1*tot_evt)-(int)(i/(0.1*tot_evt)))) cout<< (float)i/tot_evt << endl;
  ...
  outEnergies << "Number of thrown neutrinos: " << attempted_evts << endl;
